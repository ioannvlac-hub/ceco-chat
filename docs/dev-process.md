...
* Perform SonarCloud analysis
  - This is the [SonarCloud project link](https://sonarcloud.io/dashboard?id=evangelosvlachos96-dotcom_CecoChat)
* Build and push CecoChat containers to Docker Hub
  - [BFF](https://hub.docker.com/repository/docker/evangelosvlachos96/cecochat-bff)
  - [Messaging](https://hub.docker.com/repository/docker/evangelosvlachos96/cecochat-messaging)
  - [ID Gen](https://hub.docker.com/repository/docker/evangelosvlachos96/cecochat-idgen)
  - [User](https://hub.docker.com/repository/docker/evangelosvlachos96/cecochat-user)
  - [Chats](https://hub.docker.com/repository/docker/evangelosvlachos96/cecochat-chats)
